...
const cases = [
  ...
  { name: "Plastic Bottle", type: "Recyclable", route: "recycle", confidence: 95, icon: "recycle", rule: "Plastic bottle detected. Recycle bin opens.", weight: 0.04, fillImpact: 17, quantity: 1 },
  ...
  { name: "Banana Peel", type: "Organic", route: "organic", confidence: 93, icon: "leaf", rule: "Banana peel detected. Organic bin opens.", weight: 0.05, fillImpact: 15, quantity: 1 },
  ...
  { name: "Chip Packet", type: "Non-Recyclable", route: "reject", confidence: 91, icon: "trash-2", rule: "Chip packet detected. Non-recycle bin opens.", weight: 0.02, fillImpact: 13, quantity: 1 },
